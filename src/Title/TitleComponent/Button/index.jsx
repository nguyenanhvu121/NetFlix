...
function Button(props) {
  return (
    <div>
        <button className = {props.class} onClick={props.func} style={{width : props.width, height: props.height, backgroundColor: props.backgroundColor, border: props.border, borderRadius: props.borderRadius, cursor: "pointer"}}>                  
